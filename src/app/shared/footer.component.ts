      ...
      <div class="container mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-8">
          ...
          <div class="space-y-4">
            ...
            <ul class="space-y-2">
              ...
              <li><a routerLink="/register" class="text-gray-300 hover:text-white transition-colors">Join Us</a></li>
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Browse Jobs</a></li>
              <li><a href="#" class="text-gray-300 hover:text-white transition-colors">For Employers</a></li>
            </ul>
          </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center">
          <p class="text-gray-400">
            ...
            <span class="text-yellow-400">Made with ❤️ in Egypt</span>
          </p>
        </div>
      </div>
    </footer>
